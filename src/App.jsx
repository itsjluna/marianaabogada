...
<section className="hero">
  ...
  <div className="hero-text">
    <p className="hero-eyebrow">INMIGRACIÓN · ACCIDENTES · HOUSTON, TEXAS · SHEV LAW GROUP</p>
...
<div className="trust-bar animate-on-scroll animate-fade-in">
  ...
  <div className="trust-divider"></div>
  <div className="trust-item">
    <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14 16H9m10 0h3v-3.15a1 1 0 00-.84-.99L16 11l-2.7-3.6a2 2 0 00-1.6-.8H4a2 2 0 00-2 2v7h2m1 4a2 2 0 104 0 2 2 0 00-4 0zm10 0a2 2 0 104 0 2 2 0 00-4 0z"/></svg>
    Accidentes de auto
  </div>
</div>
...
<section className="about">
  ...
  <div className="about-text-block animate-on-scroll animate-fade-up delay-200">
    ...
    <p className="section-body">
      Soy Mariana, abogada en Houston, Texas. Trabajo con familias latinas que enfrentan situaciones difíciles: deportaciones, ICE, asilo, residencia — y también si sufriste un accidente de auto y no sabes qué hacer.
    </p>
    <br />
    <p className="section-body">
...
<section className="services">
  ...
  <div className="services-header animate-on-scroll animate-fade-up" style={{marginTop: '80px', marginBottom: '40px'}}>
    <p className="section-label">Otras áreas</p>
    <h2 className="section-title">Accidentes y <em>Lesiones Personales</em></h2>
    <p className="section-body">No importa tu estatus migratorio, si sufriste un accidente tienes derecho a recibir compensación justa.</p>
  </div>
  <div className="services-grid-2">
    <div className="service-card animate-on-scroll animate-fade-up delay-100">
      <div className="service-icon"><svg width="24" height="24" fill="none" stroke="#3F2644" stroke-width="1.8" viewBox="0 0 24 24"><path d="M14 16H9m10 0h3v-3.15a1 1 0 00-.84-.99L16 11l-2.7-3.6a2 2 0 00-1.6-.8H4a2 2 0 00-2 2v7h2m1 4a2 2 0 104 0 2 2 0 00-4 0zm10 0a2 2 0 104 0 2 2 0 00-4 0z"/></svg></div>
      <h3>Accidentes de Auto</h3>
      <p>Si tuviste un choque y el seguro no quiere pagarte lo justo — o si la otra parte no tenía seguro — tienes derechos. Te ayudamos a recibir la compensación que mereces, sin importar tu estatus migratorio.</p>
    </div>
    <div className="service-card animate-on-scroll animate-fade-up delay-200">
      <div className="service-icon"><svg width="24" height="24" fill="none" stroke="#3F2644" stroke-width="1.8" viewBox="0 0 24 24"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></div>
      <h3>Daños Personales</h3>
      <p>¿Te caíste en una tienda, estacionamiento o propiedad ajena? Si el lugar estaba en malas condiciones y te lastimaste, el dueño puede ser responsable. No importa tu estatus migratorio — tienes derechos y podemos ayudarte.</p>
    </div>
  </div>
</section>
...
<section className="emotional">
  <div className="animate-on-scroll animate-fade-up">
    ...
    <div className="fears-list">
      ...
      <div className="fear-item"><p>"Tuve un accidente y el seguro me ofreció muy poco. No sabía que podía pelear eso."</p></div>
    </div>
...
<section className="contact-section" id="contacto">
  <div className="animate-on-scroll animate-fade-up">
    ...
    <p className="section-body">No ignores las cartas de inmigración. No aceptes la primera oferta del seguro. La información correcta puede cambiarlo todo.</p>
...
<footer>
  ...
  <div className="footer-shev">
    ...
    <span style={{color: "rgba(255,255,255,0.2)"}}>Houston · Dallas · y todo EE. UU.</span>
  </div>
</footer>
