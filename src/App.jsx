...
<section className="hero">
  ...
  <div className="hero-left-col">
    <div className="urgency-badge animate-on-scroll">
      <div className="urgency-dot"></div>
      <span>Atención disponible en español</span>
    </div>

    <div className="hero-form-wrapper animate-on-scroll" style={{background: 'rgba(255, 255, 255, 0.05)', backdropFilter: 'blur(12px)', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.1)', padding: '16px', width: '100%', maxWidth: '420px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)'}}>
      <ContactForm title="Consulta Gratuita" subtitle="Déjanos tus datos y te llamaremos de inmediato." isDark={true} />
    </div>

    <div className="hero-cta-block animate-on-scroll delay-200">
  ...
  <div className="hero-right-col">
    <div className="hero-image-wrapper">
      <img src="images/mariana-hero.png" alt="Abogada Mariana — SHEV Law Group" />
    </div>
    
    <div className="hero-text-overlay animate-on-scroll delay-300">
      <p className="hero-eyebrow">Derecho de Inmigración · Houston, Texas</p>
      <h1 className="hero-headline">
        No estás <em>solo</em>.<br />
        Tu situación merece atención <em>seria</em>.
      </h1>
